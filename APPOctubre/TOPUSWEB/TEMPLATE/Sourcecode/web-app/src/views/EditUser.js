...
function AddCompany() {
    ...
    const handleUpdate = () => {
        ...
        if (!(data.NIT && data.bussinesName)) {
            setCommonAlert({ open: true, msg: "Introduce los campos de NIT o Razón social correctamente" });
    ...
    const isDriverOrcompany = usertype === "driver" || usertype === "company";
    const isNotAdmin = auth.profile.usertype === 'company' || auth.profile.usertype === 'driver';
        ...
        <div>
            ...
            >
                ...
                >
                    {id ?
                        (
                            (usertype === "customer" && t("update_customer_title")) || (usertype === "driver" && t("update_driver_title")) || (usertype === "company" && t("update_company_title")) || (usertype === "admin" && t("update_admin_title"))
                        )
                        :
                        (
                            (usertype === "customer" && t("add_customer_title")) || (usertype === "driver" && t("add_driver_title")) || (usertype === "company" && t("add_company_title")) || (usertype === "admin" && t("add_admin_title"))
                        )
                    }
                </Typography>
                <div
                ...
                >
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={9} xl={9}>
                        ...
                        >
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={(isDriverOrcompany && !isNotAdmin) ? 6 : 12} xl={(isDriverOrcompany && !isNotAdmin) ? 6 : 12}
                                display="flex"
                                justifyContent="center"
                                alignItems="center"
                            >
                                <Button
                                    style={{
                                        ...
                                        minHeight: 50,
                                        textAlign: "center",
                                        width: (((isDriverOrcompany && !isNotAdmin) || isMidScreen) ? "100%" : "50%")
                                    }}
