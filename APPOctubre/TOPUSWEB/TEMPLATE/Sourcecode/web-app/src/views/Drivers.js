...
export default function Users() {
  ...
  const columns = [
    ...
    {
      title: t("Billetera de Kms"),
      field: "walletKm",
      editable: "onAdd",
      render: (rowData) =>
        settings.AllowCriticalEditsAdmin ? rowData.walletKm : t("hidden_demo"),
      headerStyle: { textAlign: "center" },
    },
    {
      title: "Ciudad",
...

    {
      ...
      editable: "never",
      hiddenByExport: true,  // Oculta la columna al exportar
    ...
    },
    {
      ...
      render: (rowData) => (
        <Switch
          ...
          onChange={() => handleQueue(rowData)}
          color="error"
        />
      ),
    },
    {
      title: t("Estado del conductor"),
    ...
    },
    {
      ...
      hidden: true,
      render: (rowData) => (
        rowData.licenseImage ? 'SI' : 'NO'
      )
    },

    {
      title: 'Licencia Psterior',
      field: 'licenseImageBack',
      hidden: true,
      render: (rowData) => (
        rowData.licenseImageBack ? 'SI' : 'NO'
      )
    },

    {
      ...
      hidden: true,
      render: (rowData) => (
        rowData.SOATimage ? 'SI' : 'NO'
      )
    },
    {
      title: 'Carta de Propiedad',
      field: 'cardPropImage',
      hidden: true,
      render: (rowData) => (
        rowData.cardPropImage ? 'SI' : 'NO'
      )
    },

    {
      title: 'Carta de Propiedad posterior',
      field: 'cardPropImageBK',
      hidden: true,
      render: (rowData) => (
        rowData.cardPropImageBK ? 'SI' : 'NO'
      )
    },
...

    {
      ...
      field: 'verifyIdImageBk',
      hidden: true,
      render: (rowData) => (
        rowData.verifyIdImageBk ? 'SI' : 'NO'
      )
    },
  ...
  const handleQueue = (rowData) => {
    const updatedUser = { ...rowData, queue: !rowData.queue };
