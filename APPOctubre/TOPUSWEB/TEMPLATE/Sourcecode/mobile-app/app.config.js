...
export default {
    ...
    ios: {
        ...
        bundleIdentifier: 'com.treasapp.treas24',
        infoPlist: {
            "NSUserTrackingUsageDescription": "Para brindar un servicio de transporte confiable, utilizamos datos de ubicación para identificar la posición del usuario y facilitar la localización de vehículos cercanos. Esta información ayuda a mejorar la precisión de los viajes, brindar una mejor asistencia al cliente y garantizar la seguridad durante los trayectos.",
