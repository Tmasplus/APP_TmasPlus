...
export default function SettingsScreen(props) {
    ...
    const menuList = [
        ...
        { name: t('carnet_menu'), navigationName: 'MyCarnet', icon: 'person-add', type: 'ionicon' },
        { name: t('Insurers'), navigationName: 'Insurers', icon: 'car', type: 'font-awesome' },
        { name: 'Contratos', navigationName: 'Contratos', icon: 'description', type: 'materialIcons' },
        { name: t('cars'), navigationName: 'Cars', icon: 'car-cog', type: 'material-community' },
        { name: 'Guia para tomar servicios', navigationName: 'Instructive', icon: 'tour' },
        { name: 'Guia de Activación', navigationName: 'TourPage', icon: 'tour' },
        { name: 'Mi Familia', navigationName: 'Myfamily', icon: 'family-restroom' },
        { name: 'Atención al Cliente', navigationName: 'CustomerSupport', icon: 'support', type: 'font-awesome' },
        { name: 'Daviplata', icon: 'qrcode', navigationName: 'Daviplata', type: 'antdesign' },
        { name: t('Share'), navigationName: 'ShareQr', icon: 'share', type: 'font-awesome' },
        { name: 'Suscripción', navigationName: 'Suscription', icon: 'payments', type: 'materialIcons' },

        { name: 'Beneficios', navigationName: 'Benefis', icon: 'slideshare', type: 'entypo' },
        ...
        <View style={styles.mainView}>
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    if (auth.profile && auth.profile.usertype == "customer" && (item.navigationName == "Cars" ||
                        item.navigationName == "MyEarning" ||
                        item.navigationName == "Daviplata" ||
                        item.navigationName == "TourPage" ||
                        item.navigationName == "Instructive" ||
                        item.navigationName == "Insurers" ||
                        item.navigationName == "Suscription" ||
                        item.navigationName == "Contratos")) {
                        return null;
                    }
                        ...
                        return null;
                    } else if (auth.profile && auth.profile.usertype == "driver" && (item.navigationName == "Insurers") && !(auth.profile.carType == "TREAS-X")) {
                        return null;
                        ...
                        return null;
                    } else if (auth.profile && auth.profile.usertype == "driver" && (item.navigationName == "Myfamily")) {
                        return null
                    } else {
                        return (
                                ...
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        if (item.navigationName === 'Sos') {
                                            ...
                                            refer();
                                        } else if (item.navigationName === 'Benefis') {
                                            benefits()
