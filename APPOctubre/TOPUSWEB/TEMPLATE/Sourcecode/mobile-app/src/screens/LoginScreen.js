...
export default function LoginScreen(props) {
    ...
    const openPolitics = async () => {
        Linking.openURL(settings.CompanyPolitics).catch(err => console.error("Couldn't load page", err));
    }
    const openTreatment = async () => {
        Linking.openURL(settings.CompanyTreatment).catch(err => console.error("Couldn't load page", err));
    }
                ...
                <ScrollView style={{ width: "100%", }}>
                    <View style={{ width: '100%', height: '100%', alignItems: 'center', flex: 1, }}  >
                            ...
                            <View style={[styles.box2, { flexDirection: isRTL ? 'row-reverse' : 'row', alignItems: 'center' }]}>
                                ...
                                <View style={[styles.hideButton,{height: 40, width: 40}]} >
                                    <TouchableOpacity onPress={() => setEyePass(!eyePass)} style={{height: 40, width: 40, alignItems: isRTL ? 'flex-start' : 'flex-end', justifyContent: 'center'}} >
                                        <Feather name={eyePass ? "eye-off" : "eye"} size={20} color={colors.RED_TREAS} />
                                    </TouchableOpacity>
                                </View>
                            </View>
                            : null}
                        {state.verificationId ? null :
                            <View style={[styles.box2]}>
                                <Button
                                    ...
                                    loadingColor={{ color:  colors.RED_TREAS }}
                                />
                            </View>
                        }
                        {!!state.verificationId ?
                        ...
                        <View style={[styles.footer,{flexDirection: isRTL ? "row-reverse" : 'row'}]}>
                            ...
                            <TouchableOpacity style={styles.terms}  onPress={openPolitics}>
                    ...
                    <View style={styles.footer}>
                        <TouchableOpacity style={styles.terms} onPress={openTerms}>
                            <Text style={styles.actionTinyText}>*Al hacer uso de nuestra solución tecnológica aceptas todos nuestros Términos y Condiciones</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={styles.footer}>
                        <TouchableOpacity style={styles.terms} onPress={openTerms}>
                            <Text style={styles.actionText2}>✔{'Terminos y Condiciones'}</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.footer}>
                        <TouchableOpacity style={styles.terms} onPress={openTreatment}>
                            <Text style={styles.actionText}>✔ Tratamiento de Datos</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
