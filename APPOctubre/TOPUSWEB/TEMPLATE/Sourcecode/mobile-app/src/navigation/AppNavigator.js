            ...
            >
                {auth.profile && auth.profile.uid ?
                    <Stack.Group>
                        ...
                        <Stack.Screen name='Insurers' component={Insurers} options={{ title: t('Insurers'), ...screenOptions }} />
                        <Stack.Screen name="Contratos" component={ContratosScreen} options={{ title: 'Mis Contratos', ...screenOptions }} />
                        <Stack.Screen name='Daviplata' component={Daviplata} options={{ title: 'QR Daviplata', ...screenOptions }} />
                        <Stack.Screen name='Suscription' component={Suscription} options={{ title: 'Suscripción', ...screenOptions }} />
                        <Stack.Screen name="MyCarnet" component={MyCardId} options={{ title: 'Mi Carnet', ...screenOptions }} />
                        <Stack.Screen name="CustomerSupport" component={CustomerSupport} options={{ title: 'Atención al cliente', ...screenOptions }} />
                        <Stack.Screen name='ShareQr' component={ShareQr} options={{ title: 'Comparte y Gana', ...screenOptions }} />
                        <Stack.Screen name='Instructive' component={Instructive} options={{ title: 'Guia de Reservas', ...screenOptions }} />
                        <Stack.Screen name='TourPage' component={TourPage} options={{ title: 'Guia de Inicio', ...screenOptions }} />
                        <Stack.Screen name='wallet' component={WalletDetails} options={{ title: 'Suscripción', ...screenOptions }} />
                        <Stack.Screen name='DaviplataPayment' component={DaviplataPayment} options={{ title: t('Daviplata'), ...screenOptions }} />
                        <Stack.Screen name='RideList' component={RideListPage} options={{ title: t('booking_title'), ...screenOptions }} />
                        <Stack.Screen name='Myfamily' component={Myfamily} options={{ title: t('Myfamily'), ...screenOptions }} />
